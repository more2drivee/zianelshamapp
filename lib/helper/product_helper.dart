    ...
    ResponsiveHelper.showDialogOrBottomSheet(Get.context!, CartBottomSheetWidget(
      ...
      callback: (CartModel cartModel) {
        showCustomSnackBarHelper(
          getTranslated('added_to_cart', Get.context!),
          isError: false,
          actionLabel: ResponsiveHelper.isMobilePhone() ? getTranslated('view_cart', Get.context!) : null,
          onAction: ResponsiveHelper.isMobilePhone()
              ? () {
