          ...
          Container(
            ...
            child: Column(children: [
              ...
              if(splashProvider.configModel?.walletStatus ?? false)
                PortionWidget(imageIcon: Images.walletSvg, title: getTranslated('wallet', context)!, onRoute:()=> RouterHelper.getWalletRoute()),
              if(splashProvider.configModel?.loyaltyPointStatus ?? false)
                PortionWidget(imageIcon: Images.loyaltyPointsSvg, title: getTranslated('loyalty_point', context)!, onRoute:()=> RouterHelper.getLoyaltyScreen()),
              ...
              PortionWidget(imageIcon: Images.languageSvg, title: getTranslated('language', context)!, onRoute:()=> RouterHelper.getLanguageRoute(true)),
