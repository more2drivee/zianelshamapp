...
final GoogleSignIn _googleSignIn = GoogleSignIn(
  clientId: "317607212441-hhls1rca2o7p07sk8vpo8stnlojoakrs.apps.googleusercontent.com",
...
final bool isSuccess = response != null
    ...
    && response.data?['guest']?['id'] != null;

if (isSuccess) {
  authRepo?.saveGuestId('${response!.data['guest']['id']}');
}
    return isSuccess;
  }
