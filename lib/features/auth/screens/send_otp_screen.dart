                              ...
                              return !authProvider.isPhoneNumberVerificationButtonLoading? CustomButtonWidget(
                                ...
                                onTap: () async {
                                  ...
                                  if (_phoneNumberController!.text.isEmpty) {
                                    ...
                                    // Normalize number: strip all leading zeros
                                    final String raw = _phoneNumberController!.text.trim();
                                    final String normalizedLocal = raw.replaceFirst(RegExp(r'^0+'), '');
                                    String phoneWithCountryCode = countryCode! + normalizedLocal;
